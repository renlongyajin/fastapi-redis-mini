...
- 2025-11-12 15:25: 新增 `tests/test_settings.py`、`tests/test_docker_compose.py`，校验配置解析与 Compose 结构。
- 2025-11-12 15:40: 编写 `Dockerfile.api`、`Dockerfile.worker`、`docker-compose.yml` 并通过全部 12 项测试。
